...
function DesktopNav(){
    ...
    <aside>
        <div className='desktop-nav-main'>
            ...
            <NavLink className='nav-link' activeClassName='nav-link__active' to='/' exact><li className='desktop-nav-li'><h1>Home.</h1></li></NavLink>
            <NavLink className='nav-link' activeClassName='nav-link__active' to='/portfolio'><li className='desktop-nav-li'><h1>Portfolio.</h1></li></NavLink>
