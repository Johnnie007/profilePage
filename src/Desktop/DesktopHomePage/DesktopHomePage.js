    ...
    return(
        <div className='desktop-homepage-main'>
            <div className='desktop-homepage__header'>
                <div className='desktop-image' style={{backgroundImage: `url(${props.img})`}}></div>{props.bio ?<div className='desktop-homepage__content'>
                    <p>{props.bio}</p>
                </div> : <div className='desktop-homepage__content'>
